            ...
            <v-layout row wrap>
                        ...
                        <div slot="widget-content">
                            <v-dialog v-model="basic.dialog" persistent max-width="500px">
                                ...
                                <v-card>
                                    ...
                                    <v-card-actions>
                                        <v-spacer></v-spacer>
                                        <v-btn color="blue darken-1" flat @click.native="basic.dialog = false">Close
                                        </v-btn>
                                        <v-btn color="blue darken-1" flat @click.native="basic.dialog = false">Save
                                        </v-btn>
                                    </v-card-actions>
                                </v-card>
                            </v-dialog>
                ...
                <v-flex xl4>
                    <v-widget title="Fullscreen Dialog">
                        <div slot="widget-content">
                            <v-dialog v-model="fullscreen.dialog" fullscreen transition="dialog-bottom-transition"
                                      :overlay="false">
                                <v-btn color="primary" dark slot="activator">Open Dialog</v-btn>
                                <v-card>
                                    ...
                                    <v-list three-line subheader>
                                        ...
                                        <v-list-tile avatar>
                                            <v-list-tile-content>
                                                ...
                                                <v-list-tile-sub-title>Set the content filtering level to restrict apps
                                    ...
                                    <v-list three-line subheader>
                                        ...
                                        <v-list-tile avatar>
                                            ...
                                            <v-list-tile-content>
                                                ...
                                                <v-list-tile-sub-title>Auto-update apps at any time. Data charges may
                                                    apply
                                                </v-list-tile-sub-title>
                                            </v-list-tile-content>
                                        </v-list-tile>
                        ...
                        <div slot="widget-content">
                            <v-dialog v-model="scrollable.dialog" scrollable max-width="300px">
                                ...
                                <v-card>
                                    ...
                                    <v-divider></v-divider>
                                    <v-card-actions>
                                        <v-btn color="blue darken-1" flat @click.native="scrollable.dialog = false">
                                            Close
                                        </v-btn>
                                        <v-btn color="blue darken-1" flat @click.native="scrollable.dialog = false">
                                            Save
